...
const teams = [
  ...
  },
  {
    ...
    title: 'Finance Team',
    members: [
      { name: 'Karen Aradh', role: 'Head', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
      { name: 'Diya Sara Shyju', role: 'Member', phone: '', instagram: '', linkedin: '', email: 'saradiya2k24@gmail.com', photo: profilePlaceholder },
      { name: 'Sana Sidhique', role: 'Member', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
  ...
  },
  {
    ...
    members: [
      { name: 'Hathim Ali K H.', role: 'Head', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
      { name: 'Adithyan V S.', role: 'Member', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
      { name: 'Lakshmi B.', role: 'Member', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
  ...
  },
  {
    ...
    title: 'Outreach Team',
    members: [
      { name: 'Adithyan P L.', role: 'Head', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
      { name: 'Amarnath Siva', role: 'Member', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
  ...
  },
  {
    ...
    members: [
      { name: 'Alan Anto', role: 'Head', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
      { name: 'Sneha S Nair', role: 'Member', phone: '', instagram: '', linkedin: '', email: '', photo: profilePlaceholder },
